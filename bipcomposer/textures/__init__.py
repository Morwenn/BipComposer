...
reader_head_bottom = sfml.Texture.from_file(os.path.join('bipcomposer', 'textures', 'reader-head-bottom.png'))
reader_head_top = sfml.Texture.from_file(os.path.join('bipcomposer', 'textures', 'reader-head-top.png'))
